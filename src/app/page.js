...
export default function Home() {
  ...
  const handleImageProcessed = useCallback(async ({ file, dataUrl, info }) => {
  ...
  const handleDownload = useCallback(async (selectedDetections) => {
        ...
        {stage === 'processing' && (
          <div className="max-w-2xl mx-auto">
            <div className="text-center py-16">
              <div className="inline-block animate-spin rounded-full h-16 w-16 border-4 border-zinc-200 dark:border-zinc-800 border-t-zinc-900 dark:border-t-zinc-100 mb-6"></div>
              <h2 className="text-2xl font-semibold text-zinc-900 dark:text-zinc-50 mb-2">
                Processing...
              </h2>
              <p className="text-zinc-600 dark:text-zinc-400">
